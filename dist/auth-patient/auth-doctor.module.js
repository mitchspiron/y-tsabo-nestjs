...
AuthPatientModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [auth_doctor_controller_1.AuthPatientController],
        providers: [auth_doctor_service_1.AuthPatientService, strategies_1.AtStrategy, strategies_1.RtStrategy],
    })
], AuthPatientModule);
